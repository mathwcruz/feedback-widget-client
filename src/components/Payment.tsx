  ...
  return (
    <>
      <div className="w-screen h-full bg-primary-100 flex flex-col items-center justify-center mt-[60px] gap-[18px] pt-9 px-5">
        <h3 className="text-center max-w-[335px] text-[32px] leading-[42px] text-white dark:text-gray-300 font-medium">
          {t(
            `${I18N_BASE_PATH}.heading`,
            "Managing your ecommerce business on the go is easy."
          )}
        </h3>
        <p className="text-center max-w-[335px] text-white dark:text-gray-300 text-opacity-70 font-normal text-sm leading-6">
          {t(
      ...
      <div className="w-screen h-full bg-white dark:bg-dark-background px-5 py-20 flex flex-col justify-center">
      ...
      <div className="w-screen h-full bg-white dark:bg-dark-background px-5 pb-20 flex flex-col justify-center">
        <span className="block text-primary-100 font-medium text-base leading-5 text-left mb-2">
